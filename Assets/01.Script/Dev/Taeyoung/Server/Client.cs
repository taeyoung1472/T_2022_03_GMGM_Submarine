...
public class Client : MonoBehaviour
{
    ...
    private void InitializeClientData()
    {
        packetHandlers = new Dictionary<int, PacketHandler>()
        {
            ...
            { (int)ServerPackets.itemSpawned, ClientManager.ItemSpawned},
            { (int)ServerPackets.itemPickedUp, ClientManager.ItemPickedUp},
            { (int)ServerPackets.spawnProjectile, ClientManager.SpawnProjectile},
            { (int)ServerPackets.projectilePosition, ClientManager.ProjectilePosition},
            { (int)ServerPackets.projectileExploded, ClientManager.ProjectileExploded},
